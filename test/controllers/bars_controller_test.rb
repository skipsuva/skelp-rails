...
class BarsControllerTest < ActionController::TestCase
  ...
  test "should create bar" do
    assert_difference('Bar.count') do
      post :create, bar: { address: @bar.address, img_url: @bar.img_url, name: @bar.name, theme: @bar.theme }
    end
  ...
  test "should update bar" do
    patch :update, id: @bar, bar: { address: @bar.address, img_url: @bar.img_url, name: @bar.name, theme: @bar.theme }
    assert_redirected_to bar_path(assigns(:bar))
  end
